...
public abstract class WorkerInstance
{
  ...
  ///   <b>
  ///     Make sure you always check as frequently as you can if <see cref="WorkerInstance.CancellationToken" /> is
  ///     cancelled. For an example, see the <see cref="PrimeCalculatorWorker" />.
  ///   </b>
  /// </summary>
  /// <param name="ReportProgress">Call this to report progress up to the parent component.</param>
  /// <param name="Done">
  ///   Call this when everything is <b>done</b>. It will tell the parent component that you're ready to
  ///   <see cref="SetData(IGH_DataAccess)" />.
  /// </param>
