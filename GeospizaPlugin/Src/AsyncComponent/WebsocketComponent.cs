...
///     This class is based on the example by speckle systems:
///     <a href="https://github.com/specklesystems/GrasshopperAsyncComponent"> GitHub</a>
/// </summary>
    ...
    private void HandleWebSocketMessage(string message)
    {
        ...
        try
        {
            ...
            if (command == "run")
            {
                ...
                if (BaseWorker == null) AddRuntimeMessage(GH_RuntimeMessageLevel.Error, "Worker class not provided.");
