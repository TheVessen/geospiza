...
public abstract class AsyncComponent : GH_Component
{
  ...
  private Action<string, double> ReportProgress;
  ...
  {
    if (Workers.Count == 0 || ProgressReports.Values.Count == 0) return;
  ...
  protected override void ExpireDownStreamObjects()
  {
    ...
    if (SetData == 1) base.ExpireDownStreamObjects();
  }
