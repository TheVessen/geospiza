...
public class GH_Dynamic_Settings : GH_Component
{
    ...
    protected override void RegisterInputParams(GH_InputParamManager pManager)
    {
        ...
        pManager.AddNumberParameter("EliteSizes", "ES", "The number of elite individuals. If 0 no elite will be picked",
            GH_ParamAccess.list);
        pManager.AddGenericParameter("SelectionStrategies", "SS", "The selection strategy. As default StochasticUniversalSampling is used", GH_ParamAccess.list);
        pManager.AddGenericParameter("PairingStrategies", "PS", "The pairing strategy. As default an InBreedingFactor of 0.2 and Manhattan distance will be used", GH_ParamAccess.list);
        pManager.AddGenericParameter("CrossoverStrategies", "CS", "The crossover strategy. As default TwoPoint crossover will be used with a crossover rate of 0.6", GH_ParamAccess.list);
        pManager.AddGenericParameter("MutationStrategies", "MS", "The mutation strategy. As default random mutation will be used with a mutation rate of 0.01", GH_ParamAccess.list);
        pManager.AddGenericParameter("TerminationStrategies", "TS", "The termination strategy. As a default it will terminate if the population diversity falls below 2", GH_ParamAccess.list);
    }
