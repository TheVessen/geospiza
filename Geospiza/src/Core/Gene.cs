...
public class Gene
{
    ...
    public Gene(Dictionary<Guid, GH_NumberSlider> geneSliders, Dictionary<Guid, dynamic> genePools)
    {
        _allSliders = geneSliders;
        _allGenePools = genePools;
    }
    
    public Gene(dynamic genPoolList, int geneIndex)
    {
    ...
    public Gene(GH_NumberSlider slider)
    {
        _slider = slider;
