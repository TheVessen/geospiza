...
public class SolverSettings
{
    ...
    public string ToJson() => 
        JsonConvert.SerializeObject(this, Formatting.Indented, new EvoSettingsConverter());
...
public class EvoSettingsConverter : JsonConverter
{
    public override bool CanConvert(Type objectType) => 
        objectType == typeof(SolverSettings);
    ...
    public override object ReadJson(JsonReader reader, Type objectType, object? existingValue, JsonSerializer serializer)
    {
        ...
        {
            SelectionStrategy = GetStrategy<ISelectionStrategy>(jObject, nameof(SolverSettings.SelectionStrategy), serializer),
            CrossoverStrategy = GetStrategy<ICrossoverStrategy>(jObject, nameof(SolverSettings.CrossoverStrategy), serializer),
            ...
            TerminationStrategy = GetStrategy<ITerminationStrategy>(jObject, nameof(SolverSettings.TerminationStrategy), serializer),
