...
public class Gene
{
    ...
    /// <summary>
    ///     Gets the tick value of the gene. <see cref="GeneTemplate" /> For a gene pool list, this value represents the
    ...
    ///     It describes the total number of positions on the slider. The <see cref="TickValue" /> represents the position on
    ///     the slider, which in turn returns the actual slider value.
    /// </remarks>
