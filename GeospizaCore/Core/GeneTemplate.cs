...
public class GeneTemplate
{
    ...
    /// <summary>
    ///     Gets the unique identifier for the GH instance.This is mainly used for the gene pool list to identify a specific
    ///     slider in the gene pool list.
    /// </summary>
    ...
    ///     Thrown if the gene class has not been initialized with a dictionary of sliders and
    ///     gene pools.
    /// </exception>
