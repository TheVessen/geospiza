...
public class StateManager
{
    ...
    /// <summary>
    ///     A dictionary that holds all gene pools, where the key is a Guid and the value is a dynamic object representing the
    ///     gene pool.
    /// </summary>
    ...
    /// </summary>
    private Fitness FitnessSingleton { get; } = Fitness.Instance;
