...
public static class BrepCompute
{
  ...
  public static Brep[] CreateFromTaperedExtrude(Curve curveToExtrude, double distance, Vector3d direction,
    ...
    double angleToleranceRadians)
  {
    return ComputeServer.Post<Brep[]>(ApiAddress(), curveToExtrude, distance, direction, basePoint, draftAngleRadians,
  ...
  {
    return ComputeServer.Post<Brep[], Brep[], Brep[]>(ApiAddress(), out outBreps0, out outBreps1, face0, uv0, radius0,
...
public static class CurveCompute
{
  ...
  {
    return ComputeServer.Post<Curve[]>(ApiAddress(), curve0, point0, curve1, point1, radius, join, trim, arcExtension,
  ...
  public static PolylineCurve ToPolyline(this Curve curve, int mainSegmentCount, int subSegmentCount,
    double maxAngleRadians, double maxChordLengthRatio, double maxAspectRatio, double tolerance, double minEdgeLength,
    double maxEdgeLength, bool keepStartPoint)
  {
    return ComputeServer.Post<PolylineCurve>(ApiAddress(), curve, mainSegmentCount, subSegmentCount, maxAngleRadians,
...
public static class IntersectionCompute
{
  ...
  {
    return ComputeServer.Post<bool, Curve[], Point3d[]>(ApiAddress(), out intersectionCurves, out intersectionPoints,
